        ...
        <table class="data-table">
          ...
          <tbody v-if="!dailyLoading">
            <tr v-for="row in dailyUsage" :key="row.date">
              <td>{{ row.date }}</td>
              <td class="col-right">{{ formatNumber(row.requests) }}</td>
              ...
              <td class="col-right cost-cell">${{ formatCost(row.cost) }}</td>
            </tr>
          </tbody>
        </table>
              ...
              <td>
                <div class="progress-wrap">
                  <div class="progress-bar">
                    <div class="progress-fill" :style="{ width: getModelPercentage(row.cost) + '%' }"></div>
                  </div>
                  <span class="progress-text">{{ getModelPercentage(row.cost) }}%</span>
                </div>
              </td>
            </tr>
          </tbody>
