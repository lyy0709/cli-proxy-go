  ...
  <div class="apikeys-page">
    ...
    <div class="page-header">
      <div class="header-content">
        ...
        <p class="page-subtitle">查看和管理所有用户的 API Key</p>
      </div>
        ...
        <table class="data-table">
          ...
          <tbody v-if="!loading">
            <tr v-for="key in apiKeys" :key="key.id">
              ...
              <td class="col-user">
                <div class="user-info">
                  <div class="user-avatar">{{ (key.user?.username || '?').charAt(0).toUpperCase() }}</div>
          ...
          <div class="modal-header">
            <div class="modal-title-group">
              ...
              <div class="modal-badges">
                <span class="badge badge-info">用户: {{ currentKey?.user?.username }}</span>
...
async function handleDelete() {
  ...
  deleting.value = true
  try {
    await api.adminDeleteUserAPIKey(deleteTarget.value.user_id, deleteTarget.value.id)
